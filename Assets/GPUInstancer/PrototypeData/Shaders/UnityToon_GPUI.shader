//Unity GPUInstancer/Toon Shader
//nobuyuki@unity3d.com
//toshiyuki@unity3d.com (Intengrated) 

Shader "GPUInstancer/Toon" {
    Properties {
        [HideInInspector] _simpleUI ("SimpleUI", Int ) = 0
        [HideInInspector][Enum(OFF, 0, ON, 1)] _isUnityGPUInstancer/Toonshader("Material is touched by Unity GPUInstancer/Toon Shader", Int) = 1
        ...
        // these are set in UniversalGPUInstancer/ToonGUI.cs in accordance with _StencilMode
...
#ifdef UNITY_SHADER_VARIABLES_INCLUDED
            #include "../../HDRP/Shaders/HDRPGPUInstancer/ToonHead.hlsl"
            #include "../../HDRP/Shaders/HDRPGPUInstancer/ToonOutline.hlsl"
#endif
...
ENDHLSL
    ...
    SubShader 
    {
        ...
        Pass {
            ...
            #pragma multi_compile _IS_OUTLINE_CLIPPING_NO _IS_OUTLINE_CLIPPING_YES
            #pragma multi_compile _OUTLINE_NML _OUTLINE_POS
            // Outline is implemented in UniversalGPUInstancer/ToonOutline.hlsl.
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
#ifdef UNIVERSAL_PIPELINE_CORE_INCLUDED
            #include "../../UniversalRP/Shaders/UniversalGPUInstancer/ToonInput.hlsl"
            #include "../../UniversalRP/Shaders/UniversalGPUInstancer/ToonHead.hlsl"
            #include "../../UniversalRP/Shaders/UniversalGPUInstancer/ToonOutline.hlsl"
#endif
...
//            #pragma shader_feature _OCCLUSIONMAP
            ...
            #include "../../UniversalRP/Shaders/UniversalGPUInstancer/ToonHead.hlsl"
            #include "../../UniversalRP/Shaders/UniversalGPUInstancer/ToonBody.hlsl"
#endif
...
#pragma multi_compile_instancing
            ...
            #pragma multi_compile _OUTLINE_NML _OUTLINE_POS
            // Unity GPUInstancer/Toon Shader 0.5.0
...
//GPUInstancer/ToonCoreEnd
    ...
    CustomEditor "UnityEditor.Rendering.GPUInstancer/Toon.UTS3GUI"
}
